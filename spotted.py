...
#            "gateway":{'image_id':'ami-0a832317c0f4c5d01',}
    ...
    def __init__(self, name, profile='default', monitoring=True, script='', filesystem='', key_pair='', sec_group=''):
        ...
        if key_pair!='': 
            self.profile['key_pair']=profile                                   # if a key pair is specified use it 
        if sec_group!='':
            self.profile['security_group']=sec_group                           # if a security group is specified, use it 
        
        
        print('', flush=True)
        print('#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#', flush=True)
        print('#~#~#~#~#~#~#~# Launching '+self.name, flush=True)
        print('#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#', flush=True)
        print('', flush=True)

        try:                                                   
            instance, profile = spt.launch_spot_instance(self.name, profile, self.monitoring)  # Launch or connect to the spot instance under the given name 
