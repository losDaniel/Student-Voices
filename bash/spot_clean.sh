...
python spot_connect.py -n cleaning_A1 -p cleaning1 -f reviewdata -s scripts/instancesetup.sh
python spot_connect.py -n cleaning_A1 -p cleaning1 -f reviewdata -s scripts/script_pull.sh
ptyhon 
...
python spot_connect.py -n dtac_B1 -p cleaning1 -f reviewdata -s scripts/cleandata.sh
