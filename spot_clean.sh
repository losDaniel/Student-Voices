...
python spot_connect.py -n datac_A1 -p cleaning1 -f reviewdata -s scripts/cleansetup.sh
python spot_connect.py -n datac_A1 -p cleaning1 -f reviewdata -s scripts/cleandata_A1.sh
